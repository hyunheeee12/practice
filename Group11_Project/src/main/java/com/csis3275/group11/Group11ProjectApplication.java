...
public class Group11ProjectApplication {
	...
	CommandLineRunner carDemo(CarsDAO dao)
	{
		return (args) ->
		{
			dao.createCar(new Car("Ford", "F-150", "2015", "White", 16666.99, true, null));
			dao.createCar(new Car("Ford", "Flex", "2011", "Blue", 8666.99, true, null));
			...
			dao.createCar(new Car("Dodge", "Caravan", "2018", "Silver", 11666.99, true, null));
			dao.createCar(new Car("BYD", "Han", "2022", "Red", 31666.99, false, LocalDate.parse("2023-11-17")));
		};
	}
